...
/*cover animation*/
  ...
  (function (cjs, an) {
    ...
    lib.ssMetadata = [
          {name:"COVER_atlas_", frames: [[1194,1196,594,44],[1671,985,269,89],
          [1830,825,202,80],[1671,544,278,182],[0,0,1924,542],[618,1196,574,575],
          [0,1119,616,615],[0,544,1017,573],[1671,825,157,158],[1019,544,650,650],
          [1671,1076,357,67],[1671,728,267,95]]}
    ];
    ...
    (lib.COVER = function(mode,startPosition,loop) {
       ...
       this.timeline.addTween(cjs.Tween.get(this.instance).wait(21).to({x:591},0).wait(11).to({x:613},0).wait(9).to({x:636},0).wait(11).to({x:647},0).wait(8).to({x:630},0).wait(10).to({x:612},0).wait(1));
    
       // cloud2
       this.instance_1 = new lib.layer10();
       this.instance_1.setTransform(565,410);
    
       this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({x:537},0).wait(9).to({x:558},0).wait(10).to({x:538},0).wait(9).to({x:519},0).wait(10).to({x:544},0).wait(9).to({x:570},0).wait(9).to({x:587},0).wait(1));
    
       // cloud1
       this.instance_2 = new lib.layer9();
       this.instance_2.setTransform(105,337);
    
       this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(16).to({x:50},0).wait(9).to({x:141},0).wait(10).to({x:117},0).wait(9).to({x:95,y:323},0).wait(9).to({x:123},0).wait(17).to({x:113,y:330},0).wait(1));
       ...
       this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(17).to({x:384,y:58},0).wait(18).to({x:311,y:89},0).wait(13).to({x:349},0).wait(3).to({y:74},0).wait(7).to({x:328,y:94},0).wait(5).to({y:78},0).wait(8));
    
       // biggreen_circle
       this.instance_5 = new lib.layer7();
       this.instance_5.setTransform(184,42);
    
       this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(12).to({rotation:-23.474,x:81.45,y:198.35},0).wait(14).to({rotation:-42.9254,x:49.7,y:350.4},0).wait(8).to({rotation:-83.9087,x:151.4,y:655.65},0).wait(13).to({rotation:-113.9081,x:343.65,y:795.8},0).wait(3).to({scaleX:0.9999,scaleY:0.9999,rotation:-134.6173,x:506,y:826.55},0).wait(3).to({rotation:-168.3445,x:761.7,y:750.9},0).wait(3).to({rotation:-209.8373,x:952.65,y:487.1},0).wait(3).to({rotation:-245.5602,x:939.4,y:205.5},0).wait(4).to({rotation:-287.0001,x:724.85,y:-38.9},0).wait(4).to({rotation:-328.7294,x:400.05,y:-79.55},0).wait(3).to({scaleX:0.9998,scaleY:0.9998,rotation:-355.4448,x:210.95,y:17.1},0).wait(1));
       ...
       this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(21).to({y:151},0).wait(5).to({y:144},0).wait(8).to({y:129},0).wait(8).to({y:89},0).wait(8).to({y:72},0).wait(21));
       ...
       this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9}]}).to({state:[{t:this.instance_10},{t:this.instance_9}]},10).to({state:[{t:this.instance_10},{t:this.instance_9}]},60).wait(1));
    ...
    lib.properties = {
       ...
       opacity: 1.00,
       manifest: [
          {src:"images/COVER_atlas_.png?1583996806590", id:"COVER_atlas_"}
       ],
       preloads: []
    };
